  ...
  return (
    <div className=" 2xl:container 2xl:mx-auto md:py-12 lg:px-20 md:px-6 py-9 px-4">
      ...
      <div className="mt-4 flex md:justify-between md:items-start md:flex-row flex-col justify-start items-start">
        ...
        <div className=" border-b-2 border-gray-200 pb-2 flex justify-center items-center md:mt-0 mt-10 md:w-auto w-full "></div>
      </div>
      <div className=" flex md:flex-row flex-col md:space-x-8 md:mt-16 mt-8">
        <div className=" md:w-5/12 lg:w-4/12 w-full relative ">
          <div className="overflow-hidden">
            <img
              src="https://i.ibb.co/8bCs73h/pexels-ron-lach-8128069-1.png"
              alt="Img of Glass bottle"
              className="w-full md:block hidden animated-scale"
            />
          </div>
          <div className="overflow-hidden">
            <img
              ...
              alt="Img of Glass bottle"
              className="w-full md:hidden block animated-scale"
            />
          </div>
        </div>
